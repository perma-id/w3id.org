...
Currently, the namespace redirects to the root of this GitHub repository:
https://github.com/Fraunhofer-FIT-DSAI/drk-information-model

### Future Redirection

In the future, we plan to update the redirection to specific ontology resources:

- `https://w3id.org/drk/` --> DRK ontology and its documentation in human-readable form
- `https://w3id.org/drk.ttl` --> Serialization of the DRK ontology in Turtle format
- `https://w3id.org/drk.jsonld` --> Serialization of the DRK ontology in JSON-LD format
