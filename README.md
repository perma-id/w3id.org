...
`README.md` contains project info and contact info, for human to read.
  * Examples of `.htaccess`: [w3id.org/neat-ml/.htaccess](https://github.com/perma-id/w3id.org/blob/master/neat-ml/.htaccess) (minimal, 3 lines of code), [w3id.org/ppop/.htaccess](https://github.com/perma-id/w3id.org/blob/master/ppop/.htaccess) (handling different content types)
