# Maintainability and Architecture Requirements of Systems
...
## Maintainers
* Kim Loubat (kim.loubat@irit.fr) (GitHub ID: [KimLoubat](https://github.com/KimLoubat))
* Nathalie HERNANDEZ (nathalie.hernandez@irit.fr)
* Sophie Ebersold-Marcaillou (sophie.ebersold@irit.fr)
