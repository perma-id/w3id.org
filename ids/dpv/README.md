...
The Data Privacy Vocabulary (DPV) provides concepts to describe and represent information about processing of personal data. This [w3id](https://w3id.org/) provides a persistent URI namespace for Data Privacy Vocabulary (DPV) and other DPVCG resources, which are hosted on Github at https://github.com/w3c-cg/dpv. The w3id paths are mapped to resolved github page urls in the `.htaccess` file. 
