...
Contact Us
==========
For any queries, questions, sugestions and comments, please contact us here or open an issue in GitHub:
...
Citation Info
==========
Akbarieh, A., Bolpagni, M., Sibenik, G. (2025). BIM knowledge in context: linked (meta)data towards machine-interpretable standards. European Conference on Computing in Construction. Porto, Portugal.
