...
1. `https://w3id.org/emmo/domain/{DOMAIN}/{VERSION}                           --> https://emmo-repo.github.io/{REPO_NAME}/versions/{VERSION}/{DOMAIN}{.html|.ttl}`
   ...
   - Special cases:
     - `https://w3id.org/emmo/domain/{DOMAIN}/{VERSION}/inferred              --> https://emmo-repo.github.io/{REPO_NAME}/versions/{VERSION}/{DOMAIN}-inferred.ttl`
     - `https://w3id.org/emmo/domain/{DOMAIN}/{VERSION}/turtle                --> https://emmo-repo.github.io/{REPO_NAME}/versions/{VERSION}/{DOMAIN}.ttl`
     - `https://w3id.org/emmo/domain/{DOMAIN}/{VERSION}/dependencies          --> https://emmo-repo.github.io/{REPO_NAME}/versions/{VERSION}/{DOMAIN}-dependencies.ttl`
     - `https://w3id.org/emmo/domain/{DOMAIN}/{VERSION}/context               --> https://emmo-repo.github.io/{REPO_NAME}/versions/{VERSION}/context/context.json`
     - `https://w3id.org/emmo/domain/{DOMAIN}/{VERSION}/context/{CONTEXTNAME} --> https://emmo-repo.github.io/{REPO_NAME}/versions/{VERSION}/context/{CONTEXTNAME}.json`
...
4. `https://w3id.org/emmo/domain/{DOMAIN}                                     --> https://emmo-repo.github.io/{REPO_NAME}/{DOMAIN}{.html|.ttl}`
   ...
   - Special cases:
     - `https://w3id.org/emmo/domain/{DOMAIN}/inferred                        --> https://emmo-repo.github.io/{REPO_NAME}/{DOMAIN}-inferred.ttl`
     - `https://w3id.org/emmo/domain/{DOMAIN}/turtle                          --> https://emmo-repo.github.io/{REPO_NAME}/{DOMAIN}.ttl`
     - `https://w3id.org/emmo/domain/{DOMAIN}/dependencies                    --> https://emmo-repo.github.io/{REPO_NAME}/{DOMAIN}-dependencies.ttl`
     - `https://w3id.org/emmo/domain/{DOMAIN}/context                         --> https://emmo-repo.github.io/{REPO_NAME}/context/context.json`
     - `https://w3id.org/emmo/domain/{DOMAIN}/context/{CONTEXTNAME}           --> https://emmo-repo.github.io/{REPO_NAME}/context/{CONTEXTNAME}.json`
...
Rule 1-6 also applies to application ontologies starting with `application-`.
...
7. `https://w3id.org/emmo/{VERSION}                           --> https://emmo-repo.github.io/EMMO/versions/{VERSION}/emmo{.html|.ttl}`
   ...
   - Otherwise, redirect to squashed `.ttl` file for given version on GitHub Pages.
   - Special cases:
     - `https://w3id.org/emmo/{VERSION}/turtle                --> https://emmo-repo.github.io/EMMO/versions/{VERSION}/emmo.ttl`
     - `https://w3id.org/emmo/{VERSION}/inferred              --> https://emmo-repo.github.io/EMMO/versions/{VERSION}/emmo-inferred.ttl`
     - `https://w3id.org/emmo/{VERSION}/context               --> https://emmo-repo.github.io/EMMO/versions/{VERSION}/context/context.json`
     - `https://w3id.org/emmo/{VERSION}/context/{CONTEXTNAME} --> https://emmo-repo.github.io/EMMO/versions/{VERSION}/context/{CONTEXTNAME}.json`
...
8. `https://w3id.org/emmo/{VERSION}/source                    --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/emmo.ttl`
   ...
   - Special cases:
     - `https://w3id.org/emmo/{VERSION}/tlo                   --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/emmo-tlo.ttl`
     - `https://w3id.org/emmo/{VERSION}/mlo                   --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/emmo-mlo.ttl`
     - `https://w3id.org/emmo/{VERSION}/mereocausality        --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/mereocausality/mereocausality.ttl`
     - `https://w3id.org/emmo/{VERSION}/perspectives          --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/perspectives/perspectives.ttl`
     - `https://w3id.org/emmo/{VERSION}/multiperspective      --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/multiperspective/multiperspective.ttl`
     - `https://w3id.org/emmo/{VERSION}/reference             --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/reference/reference.ttl`
     - `https://w3id.org/emmo/{VERSION}/disciplines           --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/disciplines/disciplines.ttl`
     - `https://w3id.org/emmo/{VERSION}/disciplines/units     --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/disciplines/units/units.ttl`
...
10. `https://w3id.org/emmo                                    --> https://emmo-repo.github.io/EMMO/emmo{.html|.ttl}`
   ...
   - Special cases:
     - `https://w3id.org/emmo/inferred                        --> https://emmo-repo.github.io/EMMO/emmo-inferred.ttl`
     - `https://w3id.org/emmo/emmo-full/inferred              --> https://emmo-repo.github.io/EMMO/emmo-full-inferred.ttl`
     - `https://w3id.org/emmo/emmo-for-humans/inferred        --> https://emmo-repo.github.io/EMMO/emmo-for-humans-inferred.ttl`
     - `https://w3id.org/emmo/context                         --> https://emmo-repo.github.io/EMMO/context/context.json`
     - `https://w3id.org/emmo/context/{CONTEXTNAME}           --> https://emmo-repo.github.io/EMMO/context/{CONTEXTNAME}.json`
...
11. `https://w3id.org/emmo/source                             --> https://raw.githubusercontent.com/emmo-repo/EMMO/master/emmo.ttl`
   ...
   - Special cases:
     - `https://w3id.org/emmo/tlo                             --> https://raw.githubusercontent.com/emmo-repo/EMMO/master/emmo-tlo.ttl`
     - `https://w3id.org/emmo/mlo                             --> https://raw.githubusercontent.com/emmo-repo/EMMO/master/emmo-mlo.ttl`
     - `https://w3id.org/emmo/mereocausality                  --> https://raw.githubusercontent.com/emmo-repo/EMMO/master/mereocausality/mereocausality.ttl`
     - `https://w3id.org/emmo/perspectives                    --> https://raw.githubusercontent.com/emmo-repo/EMMO/master/perspectives/perspectives.ttl`
     - `https://w3id.org/emmo/multiperspective                --> https://raw.githubusercontent.com/emmo-repo/EMMO/master/multiperspective/multiperspective.ttl`
     - `https://w3id.org/emmo/reference                       --> https://raw.githubusercontent.com/emmo-repo/EMMO/master/reference/reference.ttl`
     - `https://w3id.org/emmo/disciplines                     --> https://raw.githubusercontent.com/emmo-repo/EMMO/master/disciplines/disciplines.ttl`
     - `https://w3id.org/emmo/disciplines/units               --> https://raw.githubusercontent.com/emmo-repo/EMMO/master/disciplines/units/units.ttl`
...
13. `https://w3id.org/emmo/raw/{VERSION}/{PATH}               --> https://raw.githubusercontent.com/emmo-repo/EMMO/{VERSION}/{PATH}`
14. `https://w3id.org/emmo/raw/{PATH}                         --> https://raw.githubusercontent.com/emmo-repo/EMMO/{PATH}`


### Redirections to ELITE
15. `https://w3id.org/emmo/elite/{VERSION}                    --> https://raw.githubusercontent.com/emmo-repo/EMMO-LITE/{VERSION}/emmo-lite.ttl`
16. `https://w3id.org/emmo/elite                              --> https://raw.githubusercontent.com/emmo-repo/EMMO-LITE/master/emmo-lite.ttl`
...
- `{REPO_NAME}`: Name of GitHub repository for domain (or application) ontology. It should start with "domain-" (or "application-") followed by `{DOMAIN}`.
