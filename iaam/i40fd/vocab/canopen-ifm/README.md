# Industry 4.0 Field Device CANOpen-ifm vocabulary

This ontology provides a vocabulary with CANOpen devices from 
ifm electronic in accordance to the [Industry 4.0 Field device](http://w3id.org/iaam/i40fd/) ontology.
